...
console.log('isEmptyString("")', isEmptyString("123")); // Виведе: true
...
function getVariableType(variable) {
  ...
  // Повертаємо встановлене повідомлення як результат функції
	let type =
		typeof variable === 'number' ? 'Це число' :
		typeof variable === 'string' ? 'Це рядок' :
		typeof variable === 'boolean' ? 'Це рядок' : 'Це інший тип';
	return type;
}
...
// Розкоментуйте після виконаня завдання
console.log("createCompose(5)", createCompose(50)); // Виведе: 12 (5+1=6, 6*2=12)
